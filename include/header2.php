...
<head>
    ...
    <style>
        ...
        .nav-links .dropdown {
            margin-right: 15px; /* Espaçamento entre o dropdown e os outros elementos */
        }
        .bg-body-tertiary{
            height: 84px;
        }
    ...
    <div class="w-100">
        <nav class="navbar bg-body-tertiary">
            <a class="navbar-brand ms-5" href="home.php"><img src="img/logo_new.png" alt="" width="100px" style="margin-top: -20px" ></a>
            <li class="nav-item dropdown me-5">
                ...
                <div class="dropdown-menu" style="margin-top: 2px;" aria-labelledby="navbarDropdownMenuLink">
